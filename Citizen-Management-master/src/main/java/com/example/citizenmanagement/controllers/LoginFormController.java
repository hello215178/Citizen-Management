...
public class LoginFormController implements Initializable {
    ...
    private Alert alert;
    private boolean forgot_vaiTro;

    private boolean register_vaiTro;
    ...
    void onRegisterBtnClicked() {
        ...
        if (!checkRegister()) {
            ...
            if(Model.getInstance().checkManagerUsernameExisted(register_username.getText())){
                ...
                if (role.getSelectedToggle().equals(role0)) register_vaiTro = false;
                else if (role.getSelectedToggle().equals(role1)) register_vaiTro = true;
    ...
    void onForgotConfirmBtn1() {
        ...
        if(checkForgotForm1()) {
            ...
            if (forgot_role.getSelectedToggle().equals(forgot_role0)) forgot_vaiTro = false;
            else if (forgot_role.getSelectedToggle().equals(forgot_role1)) forgot_vaiTro = true;
