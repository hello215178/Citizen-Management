...
//        this.luuTruNhanKhau = new luuTruNhanKhau();
    ...
    public void verifyManagerAccount(String tenDangNhap, String matKhau) {
        ...
        try {
            if(resultSet.isBeforeFirst()) {
                ...
                this.citizenManager.setVaiTro(resultSet.getBoolean(5));
    ...
    public boolean checkManagerAccountExisted(String hoTen, String tenDangNhap, String soDienThoai, boolean vaiTro) {
    ...
    public void updateManagerAccountPassword(String hoTen, String tenDangNhap, String soDienThoai, boolean vaiTro, String matKhau) {
        databaseConnection.updateCitizenManagerAccountPassword(hoTen, tenDangNhap, soDienThoai, vaiTro, matKhau);
    }
    public void registerManagerAccount(String hoTen, String tenDangNhap, String matKhau, String soDienThoai, boolean vaiTro) {
        ...
        try {
            if (resultSet.isBeforeFirst()) {
                while (resultSet.next()) {
                    ...
                    String tenKhoanThu = resultSet.getString(2);
                    boolean batBuoc = resultSet.getBoolean(3);
